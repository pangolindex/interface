...
- your private keys wallet being (a) lost, resulting in permanent and irretrievable loss of funds; or (b) compromised, resulting in the misappropriation of the your funds by malicious third parties;
...
- the creation of a hard fork in the blockchain which renders your cryptocurrencies invalid or otherwise unable to function in accordance with their intended design and purpose.
...
We will use our best efforts to resolve any potential disputes through informal, good faith negotiations. If a potential dispute arises, you must contact us by sending an email to [legal@pangolin.exchange](mailto:legal@pangolin.exchange) so that we can attempt to resolve it without resorting to formal dispute resolution. If we aren&#39;t able to reach an informal resolution within sixty days of your email, then you and we both agree to resolve the potential dispute according to the process set forth below.Any claim or controversy arising out of or relating to the Interface, this Agreement, or any other acts or omissions for which you may contend that we are liable, including (but not limited to) any claim or controversy as to arbitrability ("Dispute"), shall be finally and exclusively settled by arbitration under the Arbitration Act 2013. You understand that you are required to resolve all Disputes by binding arbitration. The arbitration shall be held on a confidential basis before a single arbitrator, who shall be selected pursuant to Arbitration Act 2013. The arbitration will be held in Panama, unless you and we both agree to hold it elsewhere. Unless we agree otherwise, the arbitrator may not consolidate your claims with those of any other party. Any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction.
...
We reserve the right, in our sole discretion, to modify this Agreement from time to time. If we make any modifications, we will notify you by updating the date at the top of the Agreement and by maintaining a current version of the Agreement at [https://github.com/pangolindex/interface](https://github.com/pangolindex/interface). All modifications will be effective when they are posted, and your continued accessing or use of the Interface will serve as confirmation of your acceptance of those modifications. If you do not agree with any modifications to this Agreement, you must immediately stop accessing and using the Interface.
...
You agree that the laws of the Panama, without regard to principles of conflict of laws, govern this Agreement and any Dispute between you and us. You further agree that the Interface shall be deemed to be based solely in the Panama, and that although the Interface may be available in other jurisdictions, its availability does not give rise to general or specific personal jurisdiction in any forum outside the Panama. You agree that Panama is the proper forum for any appeals of an arbitration award or for court proceedings in the event that this Agreement&#39;s binding arbitration clause is found to be unenforceable.

19. **Entiregreement.**

The Terms constitute the entire agreement between you and us with respect to the subject matter hereof. The Terms supersede any and all prior or contemporaneous writtenand oral agreements, communications and other understandings—if any—relating to the subject matter of the Terms.
`
