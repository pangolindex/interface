...
export const HIDE_CHILD_MENU_ACCESS_MANAGEMENT: { [chainId in ChainId]?: CHILD_MENU_TYPES[] } = {
  ...
  [ChainId.AVALANCHE]: [BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.WAGMI]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.COSTON]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.SONGBIRD]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.FLARE_MAINNET]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.HEDERA_TESTNET]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.HEDERA_MAINNET]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.NEAR_MAINNET]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.NEAR_TESTNET]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.COSTON2]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.EVMOS_TESTNET]: [BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.EVMOS_MAINNET]: [AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.ETHEREUM]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.POLYGON]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.FANTOM]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.XDAI]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.BSC]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.ARBITRUM]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.CELO]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.OKXCHAIN]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.VELAS]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.AURORA]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.CRONOS]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.FUSE]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.MOONRIVER]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.MOONBEAM]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop],
  [ChainId.OP]: [POOL_MENU_LINK.elixir, BUY_MENU_LINK.c14, AIRDROP_MENU_LINK.hederaAirdrop]
}
