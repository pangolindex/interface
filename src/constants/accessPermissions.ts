...
export const HIDE_MENU_ACCESS_MANAGEMENT: { [chainId in ChainId]?: MENU_LINK[] } = {
  ...
  [ChainId.SONGBIRD]: [MENU_LINK.stake],
  [ChainId.FLARE_MAINNET]: [MENU_LINK.stake],
  [ChainId.HEDERA_TESTNET]: [MENU_LINK.migrate, MENU_LINK.stake],
  [ChainId.HEDERA_MAINNET]: [MENU_LINK.migrate, MENU_LINK.stake],
...
export const HIDE_CHILD_MENU_ACCESS_MANAGEMENT: { [chainId in ChainId]?: CHILD_MENU_TYPES[] } = {
  ...
  [ChainId.SKALE_BELLATRIX_TESTNET]: [BUY_MENU_LINK.c14]
}
