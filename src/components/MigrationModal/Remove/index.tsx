...
const Remove = ({ allChoosePool, goNext, allChoosePoolLength }: UnstackProps) => {
  ...
  return (
    <Wrapper>
      <PoolInfo pair={pair} type="remove" />
      ...
      <Box mt={10}>
        ...
        >
          REMOVE {allChoosePoolLength > 1 && `${index + 1}/${allChoosePoolLength}`}
        </Button>
      </Box>
    </Wrapper>
  )
